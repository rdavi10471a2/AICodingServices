...
Samples are human-readable projects used to demonstrate AICodingServices behavior.
...
- `C:\VSCodeProjects\AICodingServices\samples\watched-solutions\BlazorDetectorSample`
- `C:\VSCodeProjects\AICodingServices\samples\watched-solutions\WorkflowHarnessSample`
- `C:\VSCodeProjects\AICodingServices\samples\watched-solutions\CodexWindows`
- `C:\VSCodeProjects\AICodingServices\samples\watched-solutions\CodexBlazor`
