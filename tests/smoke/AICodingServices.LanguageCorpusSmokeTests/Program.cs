...
namespace AICodingServices.LanguageCorpusSmokeTests;
...
internal static class Program
{
    ...
    {
        string corpusRoot = Path.Combine(repositoryRoot, "tests", "smoke", "AICodingServices.LanguageCorpusSmokeTests", "Corpus");
        ...
        IReadOnlyDictionary<CorpusCase, CorpusMarkup> corpus)
    {
        ...
        CSharpCompilation compilation = CSharpCompilation.Create(
            "AICodingServicesLanguageCorpus",
            trees,
    ...
    private static string ResolveRepositoryRoot(string start)
    {
        ...
        throw new DirectoryNotFoundException("Unable to resolve AICodingServices repository root.");
    }
